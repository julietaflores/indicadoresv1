...
export class FullComponent implements OnDestroy {
	...
	ngOnInit() {
		...
		if (this.userservice.responseLogin) {
			...
			(<HTMLImageElement>document.getElementById("logocompania")).src = 
			"assets/images/compania/" + this.userData_aux?.urlcompania;
			...
			//	this.userData_aux=null;
			//			this.userData_aux= this.serviceAuth.Obtener_ls_authuser();//
			//console.log('fulll'+ JSON.stringify(this.userData_aux));
